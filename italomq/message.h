...
class Message {
public:
    ItaloMQ& italomq; ///< The owning ItaloMQ object
    ...
    /// Constructor
    Message(ItaloMQ& lmq, ConnectionID cid, Access access, std::string remote)
        : italomq{lmq}, conn{std::move(cid)}, access{std::move(access)}, remote{std::move(remote)} {}
